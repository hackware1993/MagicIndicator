package net.lucode.hackware.magicindicator.buildins.verticalnavigator;
 ...
 */
public class VerticalNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    public VerticalNavigator(Context context) {
        super(context);
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.pager_navigator_layout_vertical_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.pager_navigator_layout_vertical, this);
        }

        mScrollView = (ScrollView) root.findViewById(R.id.scroll_view);   // mAdjustMode为true时，mScrollView为null
